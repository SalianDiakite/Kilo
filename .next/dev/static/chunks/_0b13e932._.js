...
function LoginPage() {
    ...
    const { isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$use$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            if (isRegister) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signUp"])(email, password, name);
                setSuccess("Compte créé ! Vérifiez votre email pour confirmer votre inscription.");
                setIsRegister(false);
            } else {
                // Sign in with Supabase
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signIn"])(email, password);
                router.push(redirect);
            }
        } catch (err) {
...
_s(LoginPage, "qFB7LzJ/XexhUaSl71S0jbT0da0=", false, function() {
    return [
...
//# sourceMappingURL=_0b13e932._.js.map