...
async function proxy(request) {
    ...
    if (pathname.startsWith("/api") || pathname.startsWith("/_next") || pathname.startsWith("/favicon") || pathname.match(/\.(ico|png|jpg|jpeg|svg|gif|webp|css|js|woff|woff2|ttf|eot)$/)) {
...
async function middleware(request) {
    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$proxy$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["proxy"])(request);
}
const config = {
    matcher: [
        /*
